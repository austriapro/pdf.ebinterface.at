                ...
                <ul className="doormat footer__doormat" id="footer-doormat">
                  ...
                  <li><h4>Themen</h4>
                    <ul className="doormat__nav">
                      ...
                      <li><a href="https://www.wko.at/service/innovation-technologie-digitalisierung/start.html">Innovation, Technologie und Digitalisierung</a></li>
                  ...
                  <li><h4>Die Wirtschaftskammer</h4>
                    <ul className="doormat__nav">
                      ...
                      <li><a href="https://www.wko.at/service/w/Informationen_fuer_die_Wirtschaftskammerwahlen_20151.html" alt="Wirtschaftskammerwahlen" target="_blank" rel="noopener noreferrer" >Wirtschaftskammerwahlen</a></li>
                      <li><a href="https://www.wko.at/Content.Node/kampagnen/Karriereportal-WKW/index.html" alt="Jobs und Karriere" target="_blank" rel="noopener noreferrer" >Jobs und Karriere</a></li>
                      <li><a href="https://www.wko.at/service/w/grundumlagen-wien.html" alt="Rechtliches" target="_blank" rel="noopener noreferrer" >Rechtliches</a></li>
                      <li><a href="https://www.wko.at/service/w/Wir-ueber-uns-2.html" alt="Wissenswertes" target="_blank" rel="noopener noreferrer" >Wissenswertes</a></li>
              ...
              <div className="panel global-panel">
                <div className="collapse" id="footer-portals">
                  <div className="container" role="tab">
                    <a aria-expanded="false" aria-controls="footer-portals" href="https://www.wko.at#footer-portals" data-toggle="collapse" className="collapsed collapse-close " data-parent="#footer-portals">
